...
public class Client {
    ...
    public void RunClient () throws IOException {
        Socket s = new Socket("10.135.16.19", 4999);
...
//thread allows u to actually implement multi-tasking,means in simple programs ur one process finishes before the second one starts ,but here we can do multiple things at the same time.
    ...
    public void displaySortedMessageHistory() {
       ...
       */
        //we copied the array so that our original array is not disturbed or not get sort only the history gets sort
